"""
MANVI: I copied thisexactly from https://gitlab.com/cheminfIBB/tfbio/-/blob/master/tfbio/data.py
"""
import pickle
        ...
        for i, atom in enumerate(molecule):
            ...
            if atom.atomicnum > 1:
                ...
                for prop in self.NAMED_PROPS:
                    try:
                        props.append(atom.__getattribute__(prop))
                    except AttributeError as e:
                        print(f"Property '{prop}' caused error: {e}")
