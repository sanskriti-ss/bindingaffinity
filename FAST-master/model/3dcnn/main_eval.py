...
parser.add_argument("--mlhdf-fn", default="pdbbind2021_demo_train.hdf", help="ml-hdf name")
parser.add_argument("--model-path", default="checkpoint_3dcnn_refined_2020/best_checkpoint.pth", help="model checkpoint file path")
