...
This is a streamlined version of the notebook converted to Python script format.
Focuses only on the classical Atomic Convolutional Neural Network (ACNN) without quantum extensions.
...
def main():
    ...
    tasks, datasets, transformers = load_pdbbind(
        ...
        pocket=True,
        reload=False,
        set_name='core'  # Use 'refined' for larger dataset
    )
